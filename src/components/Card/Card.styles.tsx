...
export const CardWrapper = styled(Box, {
  position: 'relative',
  background:
    'var(--card-background, var(--odiseo-card-background-color))',
  backdropFilter: 'var(--card-blur, none)',
  borderRadius: 'var(--border-radius-2)',
  boxShadow: 'var(--card-shadow)',
  border: '1px solid var(--odiseo-border-color)',
  overflow: 'hidden',

  variants: {
    glass: {
      true: {
        '--card-background': 'var(--odiseo-colors-foreground)',
        '--card-blur': 'blur(6px)',
      },
    },
    depth: {
...
export const CardHeader = styled('div', {
  ...
  borderBottom: '1px solid var(--odiseo-border-color)',
});
...
export const CardBody = styled('div', {
  ...
  variants: {
    dotMatrix: {
      true: {
        backgroundImage:
          'radial-gradient(var(--odiseo-border-color) 1px, transparent 0)',
