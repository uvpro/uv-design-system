  ...
  variants: {
    ...
    outline: {
      true: {
        ...
        WebkitTextStrokeColor: 'var(--odiseo-colors-typeface-primary)',
    ...
    variant: {
      ...
      primary: { color: 'var(--odiseo-colors-typeface-primary)' },
      secondary: { color: 'var(--odiseo-colors-typeface-secondary)' },
      tertiary: { color: 'var(--odiseo-colors-typeface-tertiary)' },
      info: { color: 'var(--odiseo-colors-brand)' },
      success: { color: 'var(--odiseo-colors-success)' },
      warning: { color: 'var(--odiseo-colors-warning)' },
      danger: { color: 'var(--odiseo-colors-danger)' },
    },
    weight: {
      1: {
